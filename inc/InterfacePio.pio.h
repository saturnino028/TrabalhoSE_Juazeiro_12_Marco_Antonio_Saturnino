...
#define Matriz_5x5_wrap_target 0
#define Matriz_5x5_wrap 6
#define Matriz_5x5_pio_version 0

static const uint16_t Matriz_5x5_program_instructions[] = {
            //     .wrap_target
    0x6021, //  0: out    x, 1
    0x0024, //  1: jmp    !x, 4
...
static const struct pio_program Matriz_5x5_program = {
    .instructions = Matriz_5x5_program_instructions,
    .length = 7,
    .origin = -1,
    .pio_version = Matriz_5x5_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};

static inline pio_sm_config Matriz_5x5_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + Matriz_5x5_wrap_target, offset + Matriz_5x5_wrap);
    return c;
}
